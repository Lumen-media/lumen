...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    tauri::Builder::default()
        ...
        .register_asynchronous_uri_scheme_protocol("lumen", thumbnail::protocol::handle_lumen_request)
        .register_asynchronous_uri_scheme_protocol(
            "lumen-thumb",
            thumbnail::protocol::handle_lumen_request,
        )
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            module_runtime::store::store_fetch_catalog,
            module_runtime::store::store_get_release,
            module_runtime::store::store_get_readme,
            module_runtime::store::store_get_manifest,
            module_runtime::store::store_download_module,
