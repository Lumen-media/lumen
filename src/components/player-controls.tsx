		...
		<div className="flex items-center justify-between gap-3 w-full p-3.5 rounded-xl border border-white/10 bg-background/40">
			...
			<div className="flex flex-col gap-1 flex-1">
				<div className="flex flex-col">
					...
					<p className="text-sm h-[1lh] text-muted-foreground">{currentVideo?.artist}</p>
				</div>

				<Slider />

				<div className="flex justify-between gap-1">
					<p className="text-sm text-muted-foreground">{formatDuration(progress.playedSeconds)}</p>
